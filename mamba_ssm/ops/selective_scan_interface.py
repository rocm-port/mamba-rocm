...
class MambaInnerFn(torch.autograd.Function):
    ...
    def forward(ctx, xz, conv1d_weight, conv1d_bias, x_proj_weight, delta_proj_weight,
        ...
        inspect_tensor_properties(x_dbl, name="x_dbl fn")
        ...
        # torch.save(conv1d_out, "../u_fn.pth")
        # torch.save(delta, "../delta_fn.pth")
        # torch.save(A, "../A_fn.pth")
        # torch.save(B, "../B_fn.pth")
        # torch.save(C, "../C_fn.pth")
        # torch.save(D, "../D_fn.pth")
        # torch.save(z, "../z_fn.pth")
        # torch.save(delta_bias, "../delta_bias_fn.pth")
...
def mamba_inner_ref(
    ...
    # torch.save(x, "../u_ref.pth")
    # torch.save(delta, "../delta_ref.pth")
    # torch.save(A, "../A_ref.pth")
    # torch.save(B, "../B_ref.pth")
    # torch.save(C, "../C_ref.pth")
    # torch.save(D, "../D_ref.pth")
    # torch.save(z, "../z_ref.pth")
    # torch.save(delta_bias, "../delta_bias_ref.pth")
