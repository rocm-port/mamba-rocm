            ...
            BOOL_SWITCH(params.is_variable_C, kIsVariableC, [&] {
                BOOL_SWITCH(params.delta_softplus, kDeltaSoftplus, [&] {
                    BOOL_SWITCH(params.z_ptr != nullptr , kHasZ, [&] {
                        ...
                        printf("dout batch stride: %d\nDout d stride: %d", params.dout_batch_stride, params.dout_d_stride);
                        printf("delta batch stride: %d\nDout d stride: %d", params.delta_batch_stride, params.delta_d_stride);

                        printf("Launching the kernel function\n");
