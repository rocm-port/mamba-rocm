...
FORCE_BUILD = True # TODO (changed for DEBUGGING)
...
if not SKIP_CUDA_BUILD:
    ...
    generator_flag = ["-ggdb", "-O0"] # Added -g for the debugger. Used -ggdb, but switched to g as per this thread: https://github.com/ROCm/ROCgdb/issues/14
    ...
    extra_compile_args = {
        ...
        "nvcc": [
            ...
            "-ggdb", "-O0", # TODO: for debugging # tried -ggdb also
